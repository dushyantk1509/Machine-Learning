...
original_image_file = os.path.join('images', 'fin.jpg')
style_image_file = os.path.join('images', 'final2.jpg')

vgg_path = 'imagenet-vgg-verydeep-19.mat'

original_image_weight = 5.0  #alpha for loss
style_image_weight = 500.0   #beta for loss
...
style_image = scipy.misc.imresize(style_image, [224,224])
